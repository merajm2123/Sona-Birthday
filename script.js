document.addEventListener('DOMContentLoaded', function() {
    ...
    const specialMessages = [
        "Sona, you light up every room you enter with your beautiful smile!",
        "Your kindness and warmth make the world a better place.",
        "On your special day, I wish you endless joy and happiness!",
        "You're not just amazing, you're Sona-mazing!",
        "May this year bring you all the love and success you deserve!",
        "Your friendship is one of my life's greatest blessings."
    ];
    
    // Quiz Questions
    const quizData = [
        {
            question: "What's Sona's favorite color?",
            options: ["Pink", "Blue", "Purple", "Red"],
            answer: "Blue"
        },
        {
            question: "What's Sona's favorite food?",
            options: ["Pizza", "Sushi", "Pasta", "Ice Cream"],
            answer: "Sushi"
        },
        {
            question: "What makes Sona happiest?",
            options: ["Traveling", "Reading", "Time with friends", "All of the above"],
